...
//             />
//             {!otpVerified && !otpSent && (
//               <button type="button" onClick={sendOtp} className="otp-btn bg-button hover:bg-primary/50 text-white px-3 rounded">
//                 Send OTP
//               </button>
//             )}
//           </div>
...
//               <button onClick={() => setShowDeclaration(false)} className="bg-primary text-text px-3 py-1 rounded">I Agree</button>
//             </div>
//           </div>
//         </div>
//       )}
      ...
      >
        ...
        <div className="form-section">
          ...
          <div className="amount-options">
            ...
            <label className={`amount-box other-box ${watch("amount") === "other" ? "active" : ""}`}>
              <input type="radio" value="other" {...register("amount")} />
              {watch("amount") === "other" && (
        ...
        <div className="form-section">
          ...
          {otpSent && !otpVerified && (
            <div className="input-row mt-2">
              <input type="text" placeholder="Enter OTP" value={otp} onChange={(e) => setOtp(e.target.value)} className="border rounded px-2 flex-1" />
              <button type="button" onClick={verifyOtp} className="verify-btn bg-button text-text px-3 rounded">
                Verify
              </button>
            </div>
